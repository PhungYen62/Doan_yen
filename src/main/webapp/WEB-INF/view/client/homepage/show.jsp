        ...
        <%@page contentType="text/html" pageEncoding="UTF-8" %>
            ...
            <body>
                    ...
                    <div class="container py-5">
                        <div class="row g-5 align-items-center">
                            <div class="col-md-12 col-lg-7">
                                <h4 class="mb-3 text-secondary">Thực phẩm sạch</h4>
                                <h1 class="mb-5 display-3 text-primary">Rau củ & Trái cây</h1>
                                <!-- <div class="position-relative mx-auto">
                                    <input class="form-control border-2 border-secondary w-75 py-3 px-4 rounded-pill"
                                        type="number" placeholder="Tìm kiếm sản phẩm...">
                                    <button type="submit"
                                        class="btn btn-primary border-2 border-secondary py-3 px-4 position-absolute rounded-pill text-white h-100"
                                        style="top: 0; right: 25%;">Tìm ngay</button>
                                </div> -->
                            </div>
                ...
                <div class="container-fluid py-5">
                    <div class="container py-5">
                        <div class="text-center mx-auto mb-5" style="max-width: 700px;">
                            <h1 class="display-4">Ưu đãi đặc biệt</h1>
                            <p>Những sản phẩm chất lượng với mức giá ưu đãi chỉ có trong thời gian giới hạn.</p>
                        </div>
                        <div class="row g-4">
                        ...
                        <div class="tab-class text-center">
                            <div class="row g-4">
                                ...
                                <div class="col-lg-8 text-end">
                                    ...
                                    <ul class="owl-carousel nav nav-pills d-inline-flex text-center mb-5">
                            ...
                            <div class="tab-content">
                                <c:forEach var="category" items="${categories}">
                                    <c:set var="isActive" value="${category.id == selectedCategoryId}" />
                                    <div id="tab-${category.id}"
                                        class="tab-pane fade show p-0 ${isActive ? 'show active' : ''}">
                                        <div class="row g-4">
                                            <div class="col-lg-12">
                                                <div class="row g-4">
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <c:choose>
                                                                                    <c:when
                                                                                        test="${product.salePrice != null && product.salePrice != 0 && product.salePrice < product.price}">
                ...
                <div class="container-fluid vesitable py-5">
                    <div class="container py-5">
                        <h1 class="mb-0">Các sản phẩm giảm giá</h1>
