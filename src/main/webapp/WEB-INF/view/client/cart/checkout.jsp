                                            ...
                                            <tr>
                                                <th scope="row">
                                                    <div class="d-flex align-items-center">
                                                        <img src="/products/${cartDetail.product.firstImage}"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-12 form-group mb-3">
                                                        ...
                                                        <input class="form-control" name="receiverAddress"
                                                            value="${user.province},${user.district},${user.ward},${user.address_detail}"
                                                            required />
                                                    </div>
                                                    <div class="col-12 form-group mb-3">
                                        ...
                                        <div class="col-12 col-md-6">
                                            <div class="bg-light rounded">
                                                <div class="p-4">
                                                    ...
                                                    <div class="mt-4">
                                                        <h5 class="mb-0 me-4 mb-2">Chọn hình thức thanh toán</h5>
