                ...
                <div class="content">
                    ...
                    <div class="container-fluid pt-5 px-4">
                        <div class="bg-light text-center rounded p-4">
                            ...
                            <div class="row g-3 mb-4" data-filter-toolbar data-target="#admin-category-table">
                                <div class="col-md-12">
                            ...
                            <div class="table-responsive">
                                <table id="admin-category-table" class="table text-start align-middle table-bordered table-hover mb-0">
                                    <thead>
                                        <tr class="text-dark">
                                            <th scope="col">ID</th>
